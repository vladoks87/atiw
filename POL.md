...
```mermaid
flowchart TD
    A["Kündigung des derzeit geltenden Tarifvertrages durch einen Sozialpartner oder eine Tarifvertragspartei und Bekanntgabe der Forderungen"]
    B["Bildung von Verhandlungskommissionen (Tarifkommissionen durch die beteiligten Sozialpartner)"]
    C["Verhandlungen der Tarifkommissionen über die von der Gewerkschaft aufgestellten Forderungen"]
    D{Einigung?}
    E["Abschluss eines neuen Tarifvertrages"]
    F["Einleitung des Schlichtungsverfahrens: eine Schlichtungskommission, bestehend aus Vertretern der Sozialpartner und einem neutralen Vorsitzenden, bemüht sich um Einigung"]
    G["Bis zu diesem Zeitpunkt gilt die Friedenspflicht: Verbot aller Arbeitskampfmaßnahmen (Streik und Aussperrung)"]
    H{Einigung?}
    I["Abschluss eines neuen Tarifvertrages"]
    J["Urabstimmung über die Einleitung von Arbeitskampfmaßnahmen: Streik, wenn mindestens 75% der Gewerkschaftsmitglieder zustimmen"]
    K["Mögliche Gegenmaßnahme der Arbeitgeber: Aussperrung"]
    L["Neue Verhandlungen der Sozialpartner"]
    M(("Einigung und neuer Tarifvertrag"))
    N["Ende des Streiks, wenn mindestens 25% der Gewerkschaftsmitglieder zustimmen"]
    O["Ende der Aussperrung"]
